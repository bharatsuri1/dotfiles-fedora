...
| `Super+Alt+V` | Toggle local dictation (Voxtype) | `voxtype record toggle` |
| `Super+Alt+Escape` | Cancel in-progress dictation | `voxtype record cancel` |

Local dictation is toggle-based because niri has no key-release binds. See
