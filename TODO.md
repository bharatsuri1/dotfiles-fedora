...
- [ ] If selected, install a non-DMS login manager and configure it to launch `niri-session`.
- [ ] If selected, apply a minimal Vesper-themed greeter with matching fonts, colors, user picture, and branding.
